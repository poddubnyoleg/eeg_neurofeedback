...
class BokehVisuals:
    ...
    def create_testing_charts(self):
        ...
        self.figs = [figure(plot_width=200, plot_height=125, toolbar_location=None)
        ...
        self.cds = ColumnDataSource(data={i: [] for i in [item for sublist in
                                                          [['y' + str(i), 'f' + str(i)]
                                                           for i in range(self.channels_number)] for item in
                                                          sublist] +
                                          ['x']})
    ...
    def update_protocol(self, new_features_data, current_state, current_prediction):
        ...
        self.cds_feats.stream(update_data, len(new_features_data.columns) * self.channels_number * 100)
